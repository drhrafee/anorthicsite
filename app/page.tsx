...
export default function Page() {
  ...
  const wordAnorthic = "ANORTHIC".split("");
  ...
  return (
    <div className="flex-1 flex flex-col">
      {isLoading && (
        <LoadingScreen
          onStartTransition={() => setShowContent(true)}
      ...
      >
        <section className="w-screen h-screen -mx-[4vw] -mt-[4vw] lg:-mx-[2vw] lg:-mt-[2vw] px-[4vw] pb-[4vw] lg:px-[2vw] lg:pb-[2vw] relative flex flex-col justify-end shrink-0">
          <div className="w-full">
            ...
            >
              <span className="inline-block overflow-hidden pb-[1vw]">
                {wordAnorthic.map((char, idx) => (
                  <motion.span
                    key={idx}
              ...
              <br />
              <span className="inline-flex items-baseline overflow-hidden pb-[1vw]">
                {wordStudio.map((char, idx) => (
                  <motion.span
                    key={idx}
                    className="inline-block"
                    variants={letterVariants}
                ...
                <motion.span
                  className="relative inline-flex w-[2.5vw] h-[2.5vw] md:w-[2vw] md:h-[2vw] ml-2 md:ml-4 self-center md:self-end md:mb-[0.5vw]"
                  variants={letterVariants}
                >
