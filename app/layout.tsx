...
import { Inter, Space_Grotesk, Krona_One, Geist } from 'next/font/google';
import './globals.css';
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" className={`${inter.variable} ${spaceGrotesk.variable} ${kronaOne.variable} ${geist.variable}`} suppressHydrationWarning>
